...
columns = [
        [1, 2], [4, 3], [1, 2, 5], [1, 2, 3], [1, 2, 1, 4],
        [5, 6], [3, 3, 5], [1, 8, 4], [2, 1, 3, 2], [5, 3, 2],
        [2, 2, 2], [2, 4, 1], [1, 6, 1], [1, 3, 4, 1], [5, 3]
]
rows = [
        [2, 2], [2, 2, 1], [3, 1, 4], [7, 3, 1], [2, 2, 1, 2, 1],
        [1, 4, 2], [2, 2, 1], [2, 5, 2], [3, 3, 2], [1, 1, 3, 3],
        [1, 3, 4], [8, 4], [10, 3], [5, 2, 2, 1], [2, 5]
]
